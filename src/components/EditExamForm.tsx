  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-xl w-[420px] shadow-2xl">
        <h2 className="text-xl font-bold mb-4 text-gray-800">{t('auto_120')}</h2>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('auto_348')}</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('auto_127')}</label>
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" onClick={onClose} className="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">{t('auto_065')}</button>
